...
import cn.bugfish.dove_wz25.DataBase.UserDao;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (field) {
            ...
            case "qqnumber":
                ...
                session.setAttribute("userqqnumber", newValue);
                success = userDao.updateUser(user, "qqnumber", newValue);
                break;
            ...
            case "steam64id":
                session.setAttribute("usersteam64id", newValue);
                success = userDao.updateUser(user, "steam64id", newValue);
                break;
